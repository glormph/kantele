...
urlpatterns = [
    ...
    path('show/files/', views.dataset_files_nods), # FIXME overwritten!
    ...
    path('show/samples/', views.dataset_samples_nods),
    ...
    path('show/mssamples/', views.dataset_mssamples_nods),
